...
public class HealthDataController {
    ...
    return healthDataService
        ...
        .map(
            data -> {
              ...
              map.put(
                  "activeCalories",
                  data.getActiveCalories() != null ? data.getActiveCalories() : 0.0);
              map.put("distance", data.getDistance() != null ? data.getDistance() : 0.0);
  ...
  public ResponseEntity<ApiResponse<java.util.Map<String, Object>>> getLifestyleInsights(
      @PathVariable Long userId) {
    java.util.Map<String, Object> data = healthDataService.getLifestyleInsights(userId);
    return ResponseEntity.ok(ApiResponse.ok(data));
  }
}
